...
export const enTranslations: Record<string, StockTranslation> = {
  ...
  ROP: {
    summary_short:
      "The 'Berkshire Hathaway of software.' They buy specialized software companies (#1 in niches) and let them grow. $7.9B revenue, 31% FCF margin, 33 years of dividend growth. Down -44% due to temporary headwinds.",
    summary_what:
      "Roper Technologies is a diversified technology company that acquires and operates dominant vertical software businesses in specific niches — software for lawyers (Aderant), government contractors (Deltek), freight (DAT), laboratories (Clinisys), and more. Generates 85%+ recurring revenue.\n\nOperates through three segments: Application Software (~58% revenue), Network Software (~21%), and Technology Enabled Products (~21%). Each portfolio company — from Vertafore in insurance tech to Foundry in Hollywood visual effects — holds a #1 or #2 position in its niche.\n\nIn 2025, deployed $3.3B in high-quality acquisitions: CentralReach ($1.85B, ABA therapy software with 20%+ growth) and Subsplash ($800M, digital platform for churches).",
    summary_why:
      "Roper is an elite compounding machine temporarily on sale. 31% FCF margin ($2.47B), 69.5% gross margin, and 85%+ recurring revenue — first-class SaaS metrics. Down -44% due to temporary headwinds: DOGE cuts affect Deltek (government) and freight recession affects DAT.\n\nAt $360, ROP trades at a forward P/E of 15.4x — half its historical valuation (~30x). With $6B+ in M&A capacity, 33 years of dividend growth, and a pipeline of 25+ deployed AI products, the compounding flywheel remains intact.\n\nBuy consensus with an average target of ~$478 (33% upside). The stock trades near Barclays' low target ($380), offering a margin of safety.",
    summary_risk:
      "The main risk is capital allocation execution — Roper's model depends on acquiring businesses at attractive multiples. With $9.5B in total debt (2.9x net debt/EBITDA) and ROIC of ~5-6% due to goodwill from recent acquisitions, the company must prove that CentralReach and Subsplash generate incremental returns.\n\nAdditional risks: DOGE cuts pressure Deltek's federal customer base more than expected; prolonged freight recession affects DAT; and if vertical software M&A multiples rise, the acquisition flywheel slows down.",
  },
  PNR: {
    summary_short:
  ...
  ZTS: {
    summary_short:
      "The #1 animal health company in the world. Medicines, vaccines, and diagnostics for pets and livestock. Spun off from Pfizer in 2013, with ~$9.5B in revenue and a presence in 100+ countries.",
    summary_what:
      "Zoetis is the world's largest company dedicated exclusively to animal health. It develops and manufactures medicines, vaccines, diagnostics, and technologies for companion animals (dogs, cats) and livestock (cattle, swine, poultry). Spun off from Pfizer in 2013, it inherited decades of pharmaceutical expertise and a global distribution network.\n\nIts star products include: Simparica Trio (#1 parasiticide, ~$1.5B franchise), Apoquel/Cytopoint (dermatology, $1.74B franchise), Librela/Solensia (arthritis pain, $568M), and a broad portfolio of livestock vaccines and antibiotics.\n\nZoetis generates ~65% of its revenue from companion animals and ~35% from livestock, with a presence in 100+ countries and 29 global manufacturing plants.",
    summary_why:
      "Zoetis is the undisputed leader in an industry with secular tailwinds: the 'humanization of pets' where owners treat their pets as family and spend on premium healthcare. Recurring revenue model — annual vaccines, monthly parasiticides, chronic treatments.\n\nAt $118, ZTS trades at a forward P/E of 15.7x — a massive discount vs its ~30x historical average. The stock dropped ~28% from highs ($172) due to the Librela controversy (side effects in dogs), but fundamentals are solid: 38% operating margin, $2.3B FCF, and 12 consecutive years of dividend growth.\n\nModerate Buy consensus with an average target of ~$156 (32% upside). Pipeline of 12 blockbuster candidates in oncology, kidney disease, and cardiology.",
    summary_risk:
      "The FDA is investigating Librela (dogs) and Solensia (cats) for neurological adverse effects — more than 2,300 pet deaths have been reported. The arthritis franchise already fell 3% in 2025 with an 11% decline in Q4. If regulatory restrictions escalate or veterinary confidence erodes further, it could damage a key growth pillar and the reputation of the entire brand.\n\nAdditional risks: slowdown in pet spending if the economy worsens; increasing competition in parasiticides and dermatology; currency exposure (~50% revenue outside the U.S.); and concentration in Librela/Simparica as growth drivers.",
  },
  MLI: {
    summary_short:
      "The king of industrial copper. Leading manufacturer of copper/brass tubing, fittings, and valves for plumbing, HVAC, and refrigeration. Since 1917 with the Streamline brand. $4.2B revenue and exceptional margins.",
    summary_what:
      "Mueller Industries is one of the largest manufacturers of copper, brass, aluminum, and plastic products in the Americas. Founded in 1917, the company operates through three segments: Piping Systems (copper tubing and fittings), Industrial Metals (brass and aluminum castings), and Climate (HVAC and refrigeration components).\n\nIts flagship Streamline brand has been the choice of plumbers and HVAC technicians for over 90 years. Mueller supplies the invisible but essential components that make plumbing, air conditioning, and refrigeration work in homes, commercial buildings, and industries.\n\nOperates with ~4,800 employees through subsidiaries including Mueller Streamline Co., Mueller Brass, ATCO Rubber Products, and Mueller Impact.",
    summary_why:
      "Mueller Industries is a cash flow machine hiding in plain sight. $4.2B revenue with ~18% profit margin — extraordinary for an industrial company. Copper prices are at all-time highs and Mueller benefits directly.\n\nAt $113, MLI trades at a forward P/E of 13.5x — a significant discount for a company with 10%+ revenue growth, industry-leading margins, and a pristine balance sheet. Modest (0.9%) but growing dividend, with aggressive buybacks reducing the share count.\n\nBuy consensus from analysts with an average target of ~$143 (27% upside). Mueller is the perfect infrastructure pick: every new home, every new HVAC system, every renovation uses their products.",
    summary_risk:
      "Mueller depends on copper prices — if prices fall significantly, margins compress and revenue can drop, since copper is both a raw material and a pricing component.\n\nAdditional risks: cyclicality of the construction sector (new residential and commercial); competition from plastic alternatives (PEX) replacing copper tubing in some applications; geographic concentration in North America; and risk of an economic slowdown impacting HVAC and plumbing demand.",
  },
  MDLZ: {
    summary_short:
  ...
  CCJ: {
    summary_short:
      "The largest uranium producer in the Western world. Owner of McArthur River (the highest-grade uranium mine on the planet) and 49% of Westinghouse (nuclear reactors). The fuel of the nuclear renaissance powering AI data centers.",
    summary_what:
      "Cameco Corporation is one of the largest companies in the world covering the entire nuclear fuel cycle: uranium mining, refining, conversion, and fuel services for nuclear reactors. It operates the most important mines on the planet in the Athabasca Basin (Saskatchewan, Canada): McArthur River/Key Lake — the largest high-grade uranium mine in the world, with an average grade of ~6% (approximately 100 times more concentrated than typical uranium) — and Cigar Lake, another ultra-high-grade mine. It also owns refining facilities in Blind River, conversion in Port Hope (Ontario), and fuel fabrication for CANDU reactors.\n\nIn October 2023, Cameco (49%) and Brookfield Asset Management (51%) acquired Westinghouse Electric Company for $7.9B. Westinghouse is one of the world's leading providers of nuclear reactor technology, services, and fuel, featuring the AP1000 reactor and the AP300 small modular reactor. Its customers are nuclear utilities around the world under long-term contracts (10-15 years).",
    summary_why:
      "Cameco is the purest bet on the nuclear renaissance. Multiple tailwinds are converging at once: (1) Big Tech (Microsoft, Amazon, Google, Meta) signed multi-billion dollar nuclear energy contracts to power their AI data centers — 24/7 carbon-free demand that only reactors can meet; (2) over 30 countries signed the COP28 pledge to triple global nuclear capacity by 2050; (3) the Prohibiting Russian Uranium Imports Act (May 2024) pushed the largest supplier out of the Western market, creating a structural deficit; (4) uranium spot price went from ~$20/lb in 2020 to $65-85/lb in 2025, with long-term contracts at record highs; (5) the Westinghouse acquisition is already generating incremental cash flow for Cameco; (6) Cameco has signed supply contracts through 2030+ guaranteeing predictable revenue at premium prices.",
    summary_risk:
      "The price of uranium is the biggest driver of the business and it is cyclical — if new mining projects materialize (Kazatomprom, Namibia, Australia), supply can increase and pressure prices. The valuation is very high: at a trailing P/E of 125x and forward of 54x, the stock is priced-for-perfection — any operational stumble at McArthur River or Cigar Lake, or regulatory delays at Westinghouse, could trigger steep declines. Additional risk: the dividend is low (~0.21%), so returns depend almost entirely on price appreciation, not on recurring income.",
  },
  CRRFY: {
    summary_short:
      "The world's second-largest retailer. Operates hypermarkets, supermarkets, convenience stores and cash & carry in 30+ countries. Brands: Carrefour, Atacadão (Brazil), Supeco. Revenue of ~€83B with leadership positions in France, Spain and Brazil.",
    summary_what:
      "Carrefour SA is one of the world's largest retailers, founded in 1959 in Annecy, France. It operates more than 14,000 stores in 30+ countries across multiple formats: Carrefour hypermarkets, Carrefour Market supermarkets, convenience stores (Carrefour Express, City, Contact), discount stores Supeco, cash & carry Promocash, and the Brazilian chain Atacadão — Brazil's leading cash & carry format.\n\nThe company generates ~€83B in annual revenue, with three core markets representing the majority of sales: France (~47%), Brazil (~23%) and Spain (~10%). It also operates in Italy, Belgium, Poland, Romania, Argentina, the Middle East and Africa. Beyond retail, Carrefour has operations in banking (Carrefour Banque), insurance, travel and fuel stations (Carfuel).\n\nIn February 2026, Carrefour launched its 'Carrefour 2030' strategic plan, refocusing on its three core markets and simplifying its operational structure.",
    summary_why:
      "Carrefour at $3.94 is one of the cheapest stocks in the portfolio: forward P/E of 9.5x — less than half the retail sector average. The 5.36% dividend is one of the highest in the portfolio, paid annually.\n\nThree catalysts: (1) The Carrefour 2030 plan simplifies operations and focuses on the 3 markets where they're #1 or #2 — France, Spain and Brazil; (2) Atacadão in Brazil is growing aggressively with the cash & carry format gaining market share across Latin America; (3) The stock trades near its 52-week high ($3.94) but remains cheap on fundamental metrics — the market hasn't yet recognized the operational transformation.\n\nCarrefour is the quintessential European defensive play: people buy food in any economic cycle.",
    summary_risk:
      "The food retail sector has ultra-thin margins (~2-3% net), leaving little room for operational error. Any cost increase (energy, logistics, labor) can quickly compress earnings.\n\nAdditional risks: intense competition from Lidl, Aldi and discounters in Europe pressuring prices; exposure to the French market (~47% of revenue) where consumption is weak and labor regulation is costly; the Argentina business is volatile due to inflation and currency controls; as an OTC ADR, liquidity is lower than on the Paris stock exchange (Euronext) and spreads can be wide; currency risk EUR/BRL/ARS against USD.",
  },
  CDNS: {
    summary_short:
      "Half of the duopoly that designs ALL the world's chips. Without Cadence (and rival Synopsys), Apple, NVIDIA, AMD and every modern chip wouldn't exist. Electronic design automation (EDA) software with ~80% recurring revenue and extreme switching costs.",
    summary_what:
      "Cadence Design Systems is one of two companies (along with Synopsys) that provides the essential software for designing integrated circuits, chips and electronic systems. Every modern chip — from the A18 in your iPhone to NVIDIA's GPUs that train AI models — was designed using Cadence or Synopsys tools. There is no alternative.\n\nFounded in 1988 in San Jose, California, Cadence operates across three pillars: (1) Core EDA — chip design, simulation and implementation tools (Virtuoso, Innovus, Genus, Tempus, Spectre); (2) System Design & Analysis — PCB design, multiphysics simulation, signal integrity (Allegro X, Sigrity, Celsius, Clarity 3D); (3) Life Sciences — protein modeling and biosimulation for drug discovery (OpenEye Scientific).\n\nIt also manufactures verification hardware (Palladium for emulation, Protium for prototyping) and has a strategic collaboration with NVIDIA for agentic AI chip design (Cerebrus).",
    summary_why:
      "Cadence is a shared monopoly with the deepest moat in technology. Switching costs are astronomical: changing EDA providers would require retraining thousands of engineers and redesigning workflows built over decades. ~80% of revenue is recurring.\n\nThree structural tailwinds: (1) The AI explosion requires increasingly complex chips — more transistors = more EDA licenses = more revenue for Cadence; (2) TAM expansion into system analysis (multiphysics) and life sciences doubles the addressable market beyond traditional chip design; (3) The NVIDIA partnership for agentic AI chip design positions Cadence at the center of semiconductor design's future.\n\nCadence pays no dividend — it reinvests everything in R&D and acquisitions. The return comes from price appreciation. Analyst target: ~$380 (+29% upside). Buy consensus from 22 of 31 analysts.",
    summary_risk:
      "Valuation is expensive: trailing P/E of 72x leaves no room for error. Any revenue miss or guidance reduction could cause 15-20% drops in a single day. Cadence trades as if perfection were the baseline.\n\nAdditional risks: the Synopsys-Ansys merger creates a 'silicon-to-systems' competitor threatening Cadence's multiphysics simulation expansion; China represents 11-18% of revenue and is exposed to US-China semiconductor export restrictions; pays no dividend, so returns depend 100% on price appreciation; and the EDA market, while a duopoly, has cycles tied to semiconductor capex — a chip industry recession reduces demand for design tools.",
  },
};
