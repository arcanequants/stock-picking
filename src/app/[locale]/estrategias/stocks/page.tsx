...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t("stratStocksTitle"),
    description: t("stratStocksDescription"),
    alternates: localizedAlternates(locale, "/estrategias/stocks"),
  };
}

export default async function StocksStrategyLanding() {
