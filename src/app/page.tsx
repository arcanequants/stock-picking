      ...
      {latestPick && latestTx && (
        <section className="border border-blue-500/30 bg-blue-500/5 rounded-xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs text-text-faint">{pickType}</span>
          </div>
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div>
              ...
              <Link
                ...
                className="inline-block mt-4 text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 text-sm font-medium"
              >
            ...
            <div className="text-left md:text-right shrink-0">
              ...
              {latestPick.analyst_upside && (
                <p className="text-emerald-600 dark:text-emerald-400 text-sm font-mono mt-1">
