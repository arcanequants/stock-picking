 ...
 *
 * The code length is whatever Supabase's "Email OTP Length" is configured to
 * (currently 8). We accept 6–8 digits so the client never has to hardcode a
 * length that can drift out of sync with the dashboard setting.
 *
