    ...
    <div className="md:hidden">
      ...
      {open && (
        <div className="absolute top-full left-0 right-0 bg-background border-b border-border py-4 px-4 space-y-3 z-50">
          ...
          <Link href="/picks" onClick={() => setOpen(false)} className="block text-text-secondary hover:text-foreground py-2">
            {t("picks")}
          </Link>
          <Link href="/notifications" onClick={() => setOpen(false)} className="block text-text-secondary hover:text-foreground py-2">
            {t("noticias")}
          </Link>
          <Link href="/economia" onClick={() => setOpen(false)} className="block text-text-secondary hover:text-foreground py-2">
            {t("economia")}
          </Link>
          {QUANT_LAB_ENABLED && (
          ...
          <a
            ...
            className="flex items-center gap-1 text-text-secondary hover:text-foreground py-2"
          >
            {t("terminal")}
